      ...
      <form action={formAction} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none transition focus:border-teal-500 focus:ring-2 focus:ring-teal-100"
          />
        </div>
        <div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="flex cursor-pointer flex-col items-center gap-2 rounded-xl border border-slate-200 bg-white p-3 transition has-[:checked]:border-teal-500 has-[:checked]:ring-1 has-[:checked]:ring-teal-500">
              <input
                type="radio"
                name="plan"
                value="laboratorio"
              ...
              <span className="text-sm font-semibold text-slate-900">InventaLab</span>
            </label>
            <label className="flex cursor-pointer flex-col items-center gap-2 rounded-xl border border-slate-200 bg-white p-3 transition has-[:checked]:border-teal-500 has-[:checked]:ring-1 has-[:checked]:ring-teal-500">
              <input type="radio" name="plan" value="pyme" className="sr-only" />
              <ShoppingBag className="size-5 text-teal-600" />
              <span className="text-sm font-semibold text-slate-900">InventaShop</span>
            </label>
          </div>
        </div>
