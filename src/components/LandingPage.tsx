      ...
      <section className="border-y border-slate-100 bg-slate-50/50">
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-px px-4 sm:grid-cols-4">
          {[
            ...
            { label: "Módulos totales", value: "15+" },
      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-slate-600">
            Cada sistema está diseñado para las necesidades específicas de su sector.
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-sm leading-relaxed text-slate-600">
                Control de reactivos, lotes, vencimientos, operadores, estándares de calidad y
                certificación digital. Trazabilidad completa con auditoría automática para
                cumplimiento de normas ISO 17025, NIST y más.
              </p>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-sm leading-relaxed text-slate-600">
                Punto de venta, recepción de mercancía, bodegas múltiples, kits/packs,
      ...
      <section className="bg-slate-50/50 py-20">
        <div className="mx-auto max-w-6xl px-4">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-slate-600">
              Ambos sistemas comparten una base sólida de gestión de inventario.
            </p>
          </div>
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { icon: BarChart3, title: "Reportes y gráficos", desc: "Gráficos interactivos con recharts, exportación CSV, JSON y PDF." },
              { icon: Bell, title: "Alertas proactivas", desc: "Banners automáticos para stock bajo, vencidos y vencimientos próximos." },
              { icon: Search, title: "Búsqueda global", desc: "Busca artículos por SKU, nombre o categoría desde el sidebar." },
              ...
              { icon: FileText, title: "Exportación múltiple", desc: "Exporta cualquier tabla a CSV, JSON o PDF con un solo clic." },
            ].map((feature) => (
